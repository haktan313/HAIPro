...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UBTTask_SetStatePassive_Statics::NewProp_MyOwnerComp = { "MyOwnerComp", nullptr, (EPropertyFlags)0x0044000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UBTTask_SetStatePassive, MyOwnerComp), Z_Construct_UClass_UBehaviorTreeComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UBTTask_SetStatePassive_Statics::NewProp_MyOwnerComp_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTTask_SetStatePassive_Statics::NewProp_MyOwnerComp_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UBTTask_SetStatePassive_Statics::NewProp_AIController = { "AIController", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UBTTask_SetStatePassive, AIController), Z_Construct_UClass_AHAIController_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UBTTask_SetStatePassive_Statics::NewProp_AIController_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTTask_SetStatePassive_Statics::NewProp_AIController_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_Users_Haktan_Documents_Unreal_Projects_MyProject2_Plugins_HAIPro_Source_HAIPro_Public_Tasks_BTTask_SetStatePassive_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Haktan_Documents_Unreal_Projects_MyProject2_Plugins_HAIPro_Source_HAIPro_Public_Tasks_BTTask_SetStatePassive_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBTTask_SetStatePassive, UBTTask_SetStatePassive::StaticClass, TEXT("UBTTask_SetStatePassive"), &Z_Registration_Info_UClass_UBTTask_SetStatePassive, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBTTask_SetStatePassive), 2797131755U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Haktan_Documents_Unreal_Projects_MyProject2_Plugins_HAIPro_Source_HAIPro_Public_Tasks_BTTask_SetStatePassive_h_1705369038(TEXT("/Script/HAIPro"),
		Z_CompiledInDeferFile_FID_Users_Haktan_Documents_Unreal_Projects_MyProject2_Plugins_HAIPro_Source_HAIPro_Public_Tasks_BTTask_SetStatePassive_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Haktan_Documents_Unreal_Projects_MyProject2_Plugins_HAIPro_Source_HAIPro_Public_Tasks_BTTask_SetStatePassive_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
