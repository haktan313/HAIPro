...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHEnvQueryContext_TargetActor_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "HEnvQueryContext_TargetActor.h" },
		{ "ModuleRelativePath", "Public/HEnvQueryContext_TargetActor.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UHEnvQueryContext_TargetActor_Statics::StaticCppClassTypeInfo = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UHEnvQueryContext_TargetActor_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(Z_Construct_UClass_UHEnvQueryContext_TargetActor_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UHEnvQueryContext_TargetActor_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_Haktan_Desktop_pluginNewVersions_HAIPro_HostProject_Plugins_HAIPro_Source_HAIPro_Public_HEnvQueryContext_TargetActor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Haktan_Desktop_pluginNewVersions_HAIPro_HostProject_Plugins_HAIPro_Source_HAIPro_Public_HEnvQueryContext_TargetActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHEnvQueryContext_TargetActor, UHEnvQueryContext_TargetActor::StaticClass, TEXT("UHEnvQueryContext_TargetActor"), &Z_Registration_Info_UClass_UHEnvQueryContext_TargetActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHEnvQueryContext_TargetActor), 1129306693U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Haktan_Desktop_pluginNewVersions_HAIPro_HostProject_Plugins_HAIPro_Source_HAIPro_Public_HEnvQueryContext_TargetActor_h_3520687720(TEXT("/Script/HAIPro"),
		Z_CompiledInDeferFile_FID_Users_Haktan_Desktop_pluginNewVersions_HAIPro_HostProject_Plugins_HAIPro_Source_HAIPro_Public_HEnvQueryContext_TargetActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Haktan_Desktop_pluginNewVersions_HAIPro_HostProject_Plugins_HAIPro_Source_HAIPro_Public_HEnvQueryContext_TargetActor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
